      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "05356f3c-2-" + i0 + "-" + i1 + "," + ("05356f3c-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "05356f3c-1-" + i0 + ",05356f3c-0"
      } : {}, {
        c: data,
        g: "05356f3c-3-" + i0 + ",05356f3c-0",
        h: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/HBuilderX/项目/easy-resume/pages/opendb-contacts/list.vue"]]);
