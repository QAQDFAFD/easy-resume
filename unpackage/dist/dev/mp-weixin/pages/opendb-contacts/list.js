      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "574b1c1a-2-" + i0 + "-" + i1 + "," + ("574b1c1a-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "574b1c1a-1-" + i0 + ",574b1c1a-0"
      } : {}, {
        c: data,
        g: "574b1c1a-3-" + i0 + ",574b1c1a-0",
        h: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Projects/frontend/easy-resume/pages/opendb-contacts/list.vue"]]);
